...
from dashboard.services.expose.views import (
    PingServer, PackageStatus, GraphRuleCoverage, ReleaseStatus, ReleaseStatusDetail, PackagesList, AddNewPackage
)
...
api_urls = [
    ...
    url(r'^packages$', PackagesList.as_view(), name='api_packages_list'),
    url(r'^packages/new$', AddNewPackage.as_view(), name='api_new_package'),
]
